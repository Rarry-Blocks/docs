...
Custom extensions allow developers to add new categories and blocks with unique functionality to the website that users can use.

There are two main types of extensions in Rarry:
